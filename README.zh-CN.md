...
| 看板总览 | 灵感收件箱 | AI 内容总监 |
|:--:|:--:|:--:|
| ![看板](screenshots/dashboard-overview.png) | ![收件箱](screenshots/idea-inbox.png) | ![总监](screenshots/ai-director.png) |

| 生态分析 | 选题库 | 价值地图 |
|:--:|:--:|:--:|
| ![生态](screenshots/ecosystem-analysis.png) | ![选题库](screenshots/topic-library.png) | ![价值地图](screenshots/value-map.png) |
...
如果你已经安装了 Claude Code，可以直接使用：

1. **下载项目**
   - 点击 GitHub 页面右上角的绿色按钮 `Code` → `Download ZIP`
   - 解压到任意位置（比如桌面）

2. **在 Claude Code 中使用**
   - 打开 Claude Code
   - 输入你的灵感，AI 会自动调用 Creator OS
...
1. 下载项目并解压
2. 打开 Cursor，加载项目文件夹
3. 在 Cursor 中输入灵感，AI 会自动处理

### 方式三：其他 AI 助手

任何支持 Skill/Agent 的 AI 助手都可以使用：
