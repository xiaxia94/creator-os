...
**方式二：下载 ZIP（Clone 失败时）**

如果 AI 无法 Clone 仓库（网络问题），你可以在浏览器打开：
https://github.com/xiaxia94/creator-os
点击绿色 `Code` 按钮 → `Download ZIP` → 解压到当前工作区。然后告诉 AI："项目已下载，按照 AGENTS.md 的说明帮我管理内容选题。"

**然后：**

1. **告诉 AI 你是谁** → 说"我是 AI 职场成长类创作者，主做小红书和 YouTube"
2. **粘贴灵感** → 直接粘贴你的想法，AI 自动处理
3. **查看看板** → 打开 `preview.html` 查看可视化结果
